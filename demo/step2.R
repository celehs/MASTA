...
#--
txt = paste0("ValidFt[,l]-as.matrix(cbind(1,ValidSurv[,c('", 
             paste(paste0("base_pred", 1:length(ValidSurv_pred_org)), collapse = "','"), "')]))%*%RegCoef[,l]")
...
bgbm.optim.glasso = list(bgbb = bgbm.optim.glasso, lam.glasso = lam.glasso[c(mo21, mo22, mo23, mo24)])
