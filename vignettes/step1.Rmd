...
In step I, we use the `mata.fpca` function to perform a functional PCA ([Wu et al. 2013](https://doi.org/10.5705/ss.2010.162)), which is used to estimate the mean density functions (and covariance functions) using longitudinal encounter data. 
