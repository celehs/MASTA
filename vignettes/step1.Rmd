...
In step I, a functional PCA ([Wu et al. 2013](https://doi.org/10.5705/ss.2010.162)) is first applied to estimate the mean density functions using longitudinal encounter data. 
...
The estimated mean density functions (and covariance functions) from FPCA are then used to obtain subject-specific densities, from which features will be extracted. Important features may include
...
- first functional principal component score (1stScore)
