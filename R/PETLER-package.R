...
#' @useDynLib PETLER
#' @import foreign plyr corrplot RColorBrewer rpart rpart.utils doParallel foreach survival rootSolve splines survC1 gglasso glmnet parallel
...
#' @export
petler <- function(datadir_org=NULL, datadir_base_func=NULL,
